...
{
    public class MaximumAmplifiedAura : PassiveTechnique
    {
        public override string InternalName => "MaximumAmplifiedAura";

        public MaximumAmplifiedAura() {
            Technique.cost = 50f;
        }
        ...
        public override void OnRemove(Player player)
        {
            ...
            Technique.cost = 50f; // Base

            SorceryFightPlayer sf = player.SorceryFight();
            float newCPS = sf.maxCursedEnergy / 50 + Technique.cost;
