...
namespace sorceryFight.Content.Items.DevItems
{
    ...
    {
        public override LocalizedText DisplayName => SFUtils.GetLocalization("Mods.sorceryFight.DevItems.YourTruePotential.DisplayName");
        public override LocalizedText Tooltip => SFUtils.GetLocalization("Mods.sorceryFight.DevItems.YourTruePotential.Tooltip");
