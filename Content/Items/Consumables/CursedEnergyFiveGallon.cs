...
namespace sorceryFight.Content.Items.Consumables
{
    public class CursedEnergyFiveGallon : ModItem, ICursedEnergyPotion
    {
        ...
        public override LocalizedText Tooltip => SFUtils.GetLocalization("Mods.sorceryFight.Consumables.CursedEnergyDrinks.FiveGallon.Description").WithFormatArgs(CursedEnergy);
