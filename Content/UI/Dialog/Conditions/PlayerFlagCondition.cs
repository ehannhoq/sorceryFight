...
namespace sorceryFight.Content.UI.Dialog.Conditions
{
    public class PlayerFlagCondition : ICondition
    {
        ...
        public bool Evaluate(SorceryFightPlayer sfPlayer)
        {
            ...
            SorceryFight.Log.Debug("Content/UI/Dialog/Conditions/FlagCondition: 'prop' was null.");
            ...
            SorceryFight.Log.Debug("Content/UI/Dialog/Conditions/FlagCondition: 'field' was null.");
            return false;
        }
        ...
        private bool Compare(object currentValue, Type targetType)
        {
            ...
            {
                SorceryFight.Log.Debug("Content/UI/Dialog/Conditions/FlagCondition: something went wrong with conversion.");
                return false;
            }
        }
    }
