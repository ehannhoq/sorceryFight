    ...
    public class CursedTechniqueMenu : UIElement
    {
        ...
        public override void Update(GameTime gameTime)
        {
            ...
            if (!initialized)
            {
                ...
                if (sfPlayer.sukunasFingerConsumed > 0 && conditionalIconPosUsed < conditionalIconPositions.Count)
                {
                ...
                if (sfPlayer.unlockedRCT && conditionalIconPosUsed < conditionalIconPositions.Count)
                {
                ...
                if (sfPlayer.innateTechnique.DomainExpansion.Unlocked(sfPlayer) && conditionalIconPosUsed < conditionalIconPositions.Count)
                {
