...
namespace sorceryFight.Content.Particles
{
    public class LinearParticle : Particle
    {
        ...
        public LinearParticle(Vector2 position, Vector2 velocity, Color color, float drag = 1, float scale = 1, int lifetime = 60) : base(Texture, position, velocity, color, drag, scale, lifetime)
        {
        ...
        public override void Draw(SpriteBatch spriteBatch)
        {
            ...
            spriteBatch.Draw(Texture, position, src, color, rotation, origin, scaleVec, SpriteEffects.None, 0f);
            spriteBatch.Draw(Texture, position, src, new Color(255, 255, 255, 160), rotation, origin, scaleVec * 0.90f, SpriteEffects.None, 0f);
