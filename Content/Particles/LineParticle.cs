...
namespace sorceryFight.Content.Particles
{
    public class LineParticle : Particle
    {
        ...
        public override string Texture => "sorceryFight/Content/Particles/DrainLineBloom";

        public LineParticle(Vector2 relativePosition, Vector2 velocity, bool affectedByGravity, int lifetime, float scale, Color color)
        {
