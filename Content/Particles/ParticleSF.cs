...
namespace sorceryFight.Content.Particles
{
    ...
    public abstract class ParticleSF
    {
        ...
        public ParticleSF(Texture2D texture, Vector2 position, Vector2 velocity, Color color, bool isUIParticle = false, float drag = 1f, float scale = 1f, int lifetime = 60)
        {
