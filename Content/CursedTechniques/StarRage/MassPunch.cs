...
{
    public class MassPunch : CursedTechnique
    {
        ...
        public override string InternalName => "MassPunch";
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            if (texture == null && !Main.dedServ)
                texture = ModContent.Request<Texture2D>("sorceryFight/Content/CursedTechniques/StarRage/MassPunch").Value;
