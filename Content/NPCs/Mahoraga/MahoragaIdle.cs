...
{
    public class MahoragaIdle(BossNPC bossNPC) : AIState(bossNPC)
    {
        private static readonly int FRAMES = 8;
        private static readonly int TICK_PER_FRAME = 15;
        private static readonly Texture2D texture = ModContent.Request<Texture2D>("sorceryFight/Content/NPCs/Mahoraga/MahoragaBoss", AssetRequestMode.ImmediateLoad).Value;
        ...
        public override void AI(NPC npc)
        {
            ...
            // if (npc.target != -1)
                // bossNPC.SetState(new MahoragaWalk(bossNPC));
        }
