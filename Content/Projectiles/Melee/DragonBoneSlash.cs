...
{
    public class DragonBoneSlash : ModProjectile
    {
        ...
        public override void SetStaticDefaults()
        {
            ...
            texture = ModContent.Request<Texture2D>("sorceryFight/Content/Projectiles/Melee/DragonBoneSlash", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
        }
