    ...
    public class IdleDeathGamble : DomainExpansion
    {
        ...
        public override void AI()
        {
            ...
            if (NPC.ai[0] > 30)
            {
                ...
                if (rollTimer < 240)
                {
                    rollOnePosition.Y += 200f;
                    rollTwoPosition.Y += 200f;
                    rollThreePosition.Y += 200f;
                ...
                if (rollTimer >= 180)
                    rollOnePosition = Owners[NPC.whoAmI].Center - Main.screenPosition - new Vector2(rollOneTexture.Width + 150, 0);
                if (rollTimer >= 210)
                    rollTwoPosition = Owners[NPC.whoAmI].Center - Main.screenPosition;
                if (rollTimer >= 240)
                    rollThreePosition = Owners[NPC.whoAmI].Center - Main.screenPosition + new Vector2(rollThreeTexture.Width + 150, 0);
